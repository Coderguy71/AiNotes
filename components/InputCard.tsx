...
export default function InputCard({ onGenerate, error }: InputCardProps) {
  ...
  return (
    <div className="animate-fade-in rounded-[--radius-lg] bg-cream p-4 sm:p-6 md:p-8 shadow-[--shadow-lg] transition-all duration-[--animate-duration-normal] hover:shadow-[--shadow-xl]">
      <h2 className="mb-4 sm:mb-6 font-serif text-2xl sm:text-3xl text-charcoal">
        Your Thoughts
      </h2>
